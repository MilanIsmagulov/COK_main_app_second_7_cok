let themeName = "Основы стандартизации";

let allQuestions = [
    {
        type: 1,
        price: 100,
        text: 'Что такое технический регламент? Выберите все правильные ответы.',
        image: false,
    ...
    {
        type: 6,
        text: "Сопоставьте виды документов с их определениями.",
        leftContents: [
    ...
    },
    {
        type: 1,
        price: 200,
        text: 'Какие из следующих стандартов связаны с информационной безопасностью? Выберите все правильные ответы.',
        image: false,
    ...
    },   
    {
        type: 1,
        price: 250,
        text: 'Проанализируйте описание технического регламента безопасности электрических приборов и выберите, какие шаги должен пройти производитель для соответствия этому регламенту. Выберите все правильные ответы.',
        image: false,
    ...
    }, 
    {
        ...
        text: 'Впишите термин.',
        textDd: "!- тип документа, устанавливающий обязательные требования к безопасности продукции на территории стран Таможенного союза.",
        correctAnswer: ["Технический регламент"], // Индексы для выпадающих списков и строки для полей ввода
        answered: null, // Флаг, ответили ли на этот вопрос
    },      
    {
        type: 1,
        price: 100,
        text: 'Какова основная цель стандартизации? Выберите все правильные ответы.',
        image: false,
    ...
    {
        type: 6,
        text: "Соотнесите документы стандартизации с их описанием.",
        leftContents: [
            { type: 'text', value: 'ГОСТ' }, 
    ...
    {
        type: 6,
        text: "Найдите соответствие между документами по стандартизации и их функциями.",
        leftContents: [
            { type: 'text', value: 'ISO/IEC' },
    ...
    },
    {
        type: 1,
        price: 250,
        text: 'Проанализируйте пример использования стандарта ГОСТ Р 57107-2016 в разработке мобильного приложения и укажите, какие из перечисленных процессов были стандартизированы согласно этому документу. Выберите все правильные ответы.',
        image: false,
    ...
    },
    {
        ...
        textDd: "Метод стандартизации, используемый для достижения большей совместимости и минимизации дублирования в производственных процессах, называется - метод !",
        correctAnswer: ["унификации"], // Индексы для выпадающих списков и строки для полей ввода
        answered: null, // Флаг, ответили ли на этот вопрос
    }, 
    {
        type: 1,
        price: 100,
        text: 'Какой из методов стандартизации направлен на установление наилучшего сочетания безопасности и эффективности? Выберите все правильные ответы.',
        image: false,
    ...
    {
        type: 6,
        text: "Соотнесите документы регламентации стандартов в информационных технологиях с областью их применения.",
        leftContents: [
    ...
    {
        type: 6,
        text: "Сопоставьте методы стандартизации с их примерами.",
        leftContents: [
    ...
    },
    {
        ...
        price: 300, // Цена вопроса
        text: 'Впишите термин.',
        textDd: "Какой термин означает введение национального стандарта в соответствии с международными или региональными стандартами? Ответ:!",
        answers: [
            ["Узбекистане", "Ираке", "России"], // Для первого выпадающего списка (индекс 0)
            ["1950","3572","824"]               // Для второго выпадающего списка (индекс 1)
        ],
        correctAnswer: ["Гармонизация"], // Индексы для выпадающих списков и строки для полей ввода
        answered: null, // Флаг, ответили ли на этот вопрос
    },       
];