...
let allQuestions = [
    ...
    }, 
    {
        ...
        text: 'Дайте определение:',
        textDd: "Какой тип документа устанавливает обязательные требования к безопасности продукции на территории стран Таможенного союза? !",
        answers: [
    ...
    },
    {
        ...
        price: 300, // Цена вопроса
        text: 'Дайте определение:',
        textDd: "Какой термин означает введение национального стандарта в соответствии с международными или региональными стандартами? !",
        answers: [
            ["Узбекистане", "Ираке", "России"], // Для первого выпадающего списка (индекс 0)
            ["1950","3572","824"]               // Для второго выпадающего списка (индекс 1)
        ],
